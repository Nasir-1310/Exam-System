...
//below code work with next/Image , when aws will include use next/Image.
...
//   // Helper function to handle image URL changes and convert Google Drive URLs
//   const handleImageUrlChange = (url: string, field: string) => {
//     let displayUrl = url;
...
//                       handleImageUrlChange(e.target.value, "image_url")
//                     }
//                     onBlur={(e) => handleImageUrlChange(e.target.value, "image_url")}
//                     className="w-full h-32 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-gray-700"
//                     placeholder="অথবা Google Drive লিংক পেস্ট করুন"
//                   />
//                 </div>
...
//               {/* Image Preview */}
//               {formData.image_url && (
//                 <div className="mt-2 relative w-full h-48 bg-gray-50 rounded-lg overflow-hidden">
//                   <Image
...
//                     {/* Option Image - Combined Upload and URL */}
...
//                           onChange={(e) => {
//                             const file = e.target.files?.[0];
//                             if (file) handleFileUpload(file, `option_${letter.toLowerCase()}_image_url` as any);
//                           }}
//                           disabled={uploadingFiles[`option_${letter.toLowerCase()}` as keyof typeof uploadingFiles]}
//                         />
//                       </label>
...
//                           )
//                         }
//                         className="w-full px-2 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-xs text-gray-700"
//                         placeholder="অথবা Drive লিংক"
//                       />
//                     </div>
